...
public class HiloFertirrigacion extends Thread {
    ...
    private static final int ID_FERTIRRIGACION = SistemaRespaldo1.ESTADO_FERTIRRIGACION;
        ...
        try {
            while (on) {
                try {
                    ...
                    SistemaRespaldo1.solicitarBomba(SistemaRespaldo1.ESTADO_FERTIRRIGACION, 0);
                    ...
                    try {
                        ...
                        SistemaRespaldo1.liberarBomba(ID_FERTIRRIGACION);
                    }
