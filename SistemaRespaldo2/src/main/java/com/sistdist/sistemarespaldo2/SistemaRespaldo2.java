...
public class SistemaRespaldo2 extends UnicastRemoteObject implements IDetectorFalla, IEleccionAnillo {
    ...
    private static final int MI_PUERTO_RMI = 9002;
    ...
    private static Boolean SM_CAIDO = false;
    ...
    private static SistemaRespaldo2 instanciaRMI;

    private static ServerSocket servidorAplicacion = null;

    public SistemaRespaldo2() throws RemoteException {
        super(MI_PUERTO_RMI);
        int condition = 1;
        while (condition < 3) {
    ...
    public void iniciarEleccion(List<Integer> idsParticipantes, Integer maestroElegido) throws RemoteException {
        if (SM_CAIDO && M_CAIDO) {
            coordinadorElegido(MI_ID, "rmi://localhost:9002/ServidorRespaldo3");
            return;
        }
        conectarSucesor();
        try {
        ...
        if (idsParticipantes.contains(MI_ID)) {
            ...
            try {
                ...
                System.err.println("❌ ERROR RMI: Sucesor en " + DIRECCION_MAESTRO_RMI + " falló. Anillo roto.");
            }
        }
    }
    ...
    private void chequearMaestro() {
        try {
            ...
            try {
                ...
                if (idCoordinadorActual == ID_MAESTRO) {
                    M_CAIDO = true;
    ...
    public static void main(String[] args) {
        ...
        try {
            conectarServidorEM();
            instanciaRMI = new SistemaRespaldo2();
    ...
    private static void conectarServidorEM() throws NotBoundException, MalformedURLException, RemoteException {
