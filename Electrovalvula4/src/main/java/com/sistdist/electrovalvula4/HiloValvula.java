...
public class HiloValvula extends Thread{
    ...
    public void run() {
        try {
            ...
            System.err.println("❌ HiloValvula: Falla de conexión detectada. Terminando hilo.");
            Logger.getLogger(HiloValvula.class.getName()).log(Level.SEVERE, "Falla en la comunicación con SC.", ex);
