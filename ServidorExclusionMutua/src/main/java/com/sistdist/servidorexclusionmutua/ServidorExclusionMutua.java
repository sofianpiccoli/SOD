...
public class ServidorExclusionMutua {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Registry de Exclusión Mutua listo en el puerto " + nroPuertoExcMutua);
            ...
            System.out.println("✅ Servidor de Exclusión Mutua para la bomba registrado y listo.");
